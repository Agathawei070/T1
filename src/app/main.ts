...
console.log(`Bem-vindo ao Pet Lover onde oferecemos serviços de pet shops e clínicas veterinarias`)
...
while (execucao) {
    ...
    console.log(`6 - Registro de consumo dos produtos ou serviços que cada cliente adquiriu.`)
    console.log(`7 - Listagem dos 10 clientes que mais consumiram produtos ou serviços.`)
    console.log(`8 - Listagem geral dos serviços ou produtos mais consumidos.`)
    console.log(`9 - Listagem dos serviços ou produtos mais consumidos por tipo e raça de pets.`)
    console.log(`10 - Listagem dos 5 clientes que mais consumiram em valor.`)
    console.log(`0 - Sair`)
